...
export const Product = ({ title, description, image, thumbnail }: { title: string, description: string, image: string, thumbnail: string }) => {
  ...
  return (
    <div className="single-product">
      ...
      <div className="flex items-center gap-5 sm:px-5">
        <Image src={image} alt={title} width={isMobileDevice ? 60 : 90} height={isMobileDevice ? 60 : 90} />
        <div>
