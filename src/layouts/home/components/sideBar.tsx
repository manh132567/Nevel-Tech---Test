...
export const SideBar = () => {
  ...
  const menu: {
    ...
    () => [
      {
        icon: <HomeIcon />,
        label: isMobileDevice ? t('menuMobile.home') : t('menu.home'),
      },
      {
        icon: <TimeLineIcon />,
        label: isMobileDevice ? t('menuMobile.timeLine') : t('menu.timeLine'),
      },
      {
        icon: <AllGameIcon />,
        label: isMobileDevice ? t('menuMobile.allGame') : t('menu.allGame'),
      },
    ],
    [isMobileDevice]
  );
